...
import { DraftEntityInstance } from './draft-entity-instance';
import { DraftEntityMutability } from './draft-entity-mutability';
import { DraftEntityType } from './draft-entity-type';

var instances: Map<string, DraftEntityInstance> = Map<string, DraftEntityInstance>();
var instanceKey = 0;
 ...
 * via DraftEntity.get().
 */
export var DraftEntity: DraftEntityMapObject = {
  /**
  ...
  __mergeData: function(
    ...
    var newInstance = instance.set('data', newData) as DraftEntityInstance;
  ...
  __replaceData: function(
    ...
    const newInstance = instance.set('data', newData) as DraftEntityInstance;
    instances = instances.set(key, newInstance);
    return newInstance;
  },
};
