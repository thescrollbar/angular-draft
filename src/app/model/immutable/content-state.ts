...
import { BlockMapBuilder } from './block-map-builder';
...
import { sanitizeDraftText } from '../encoding/sanitize-draft-text';
import { BlockMap } from './block-map';
import { DraftEntityInstance } from '../entity/draft-entity-instance';
...
export class ContentState extends ContentStateRecord {
  ...
  static createFromText(
    ...
    const strings = text.split(<RegExp> delimiter);
